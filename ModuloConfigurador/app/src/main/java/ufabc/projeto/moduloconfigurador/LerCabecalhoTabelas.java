...
public class LerCabecalhoTabelas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ler_cabecalho_tabelas);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LerCabecalhoTabelas.this,LerNumeLinhaColuna.class));
            }
        });
