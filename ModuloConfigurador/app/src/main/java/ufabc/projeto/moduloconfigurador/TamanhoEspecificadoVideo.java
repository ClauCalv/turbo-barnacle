...
public class TamanhoEspecificadoVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamanho_especificado_video);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(TamanhoEspecificadoVideo.this,EscolherCorTexto.class));
            }
        });
