...
public class AtivarDigitacaoInteligente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ativar_digitacao_inteligente);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AtivarDigitacaoInteligente.this,MostrarControleZoom.class));
            }
        });
