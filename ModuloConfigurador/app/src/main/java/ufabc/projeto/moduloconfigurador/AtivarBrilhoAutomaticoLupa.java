...
public class AtivarBrilhoAutomaticoLupa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ativar_brilho_automatico_lupa);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AtivarBrilhoAutomaticoLupa.this,AlterarContraste.class));
            }
        });
