...
public class FalarTextoSelecionado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_falar_texto_selecionado);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    startActivity(new Intent(FalarTextoSelecionado.this,LetrasMaiusculas.class));
            }
        });
