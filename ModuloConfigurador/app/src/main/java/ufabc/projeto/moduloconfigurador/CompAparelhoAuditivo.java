...
public class CompAparelhoAuditivo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comp_aparelho_auditivo);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CompAparelhoAuditivo.this,DisponivelLegendaSurdo.class));
            }
        });
