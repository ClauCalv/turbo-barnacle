...
public class DigitarAssitentePessoal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_digitar_assitente_pessoal);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DigitarAssitentePessoal.this,ConfigurarRetornoVoz.class));
            }
        });
