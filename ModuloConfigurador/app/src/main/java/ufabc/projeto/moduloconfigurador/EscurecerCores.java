...
public class EscurecerCores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_escurecer_cores);
        ...
        simBotao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(EscurecerCores.this,TecladoAltoContraste.class));
            }
        });
