...
public class Gravacao implements Serializable {
    ...
    private String fileLocation, fileName, fileExtension, annotationLocation, annotationName, annotationExtension = ".xml";
    private boolean saveRecord, saveAnnotations;
    private SparseArray<Annotations> annotations;
    private boolean lastSaved, failed = true;
    private int lastAnnotationID = 0;

    public static Gravacao postedInstance;

    public static String formatTime(long time){
        long hh = time / (1000*60*60), mm = time / (1000*60) % 60, ss = time / 1000 % (60*60);
        return hh>0
    ...
    public static Gravacao LoadFromFile(String annotationLocation, String annotationName){
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                if(eventType == XmlPullParser.START_TAG) {
                    if (parser.getName().equals("Record")) {
                        ...
                        long milissec = Long.valueOf(parser.getAttributeValue(null, "time"));
        ...
        gravacao.lastAnnotationID = annotations.keyAt(annotations.size()-1);
    ...
    public Annotations addAnnotation(long milissec, String name){
    ...
    private Annotations addAnnotation(long milissec, int id, String name){
    ...
    public class Annotations implements Serializable {
        ...
        public Annotations(long millissec, String name){
            this(millissec, ++lastAnnotationID, name);
        }

        /**UNSAFE*/
        protected Annotations(long millissec, int id, String name){
            this.time = millissec;
            this.name = name;
            this.id = id;
        }
        ...
        public Bitmap getIcon(int targetW, int targetH){
            ...
            if(icon != null && targetW == iconW && targetH == iconH)
                return icon;
